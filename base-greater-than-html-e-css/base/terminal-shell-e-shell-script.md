...
|                                          | `tail [arquivo]`        | Mostra as últimas linhas de um arquivo (por padrão, as 10 últimas).                                                                                                      | `tail arquivo.txt`, `tail -f arquivo.txt`                                                 |  `-f` (follow) monitora o arquivo em tempo real, mostrando novas linhas conforme são adicionadas.                         |
|                                          | `wc [arquivo]`          | Conta palavras, linhas e caracteres em arquivos.                                                                                                                         | <p><code>wc arquivo.txt,</code><br><code>wc -l arquivo.txt, wc -w arquivo.txt</code> </p> | `-l`  conta apenas as linhas, `-w` conta apenas as palavras.                                                              |
